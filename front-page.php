...
function parallax_homepage_widgets() {
	...
	genesis_widget_area( 'home-section-1', array(
		'before' => '<div id="hero-section" class="home-odd home-section-1 widget-area"><div class="full-height"><div class="wrap">',
		'after'  => '</div></div></div><div id="about-nav"></div>',
	) );

	genesis_widget_area( 'home-section-2', array(
		'before' => '<div class="about-section home-even home-section-2 widget-area"><div class="wrap">',
		'after'  => '</div></div>',
	) );

	genesis_widget_area( 'home-section-3', array(
		'before' => '<div id="projects-nav"></div><div id="projects-section" class="home-odd home-section-3 widget-area"><div class="wrap">',
		'after'  => '</div></div><div id="support-nav"></div>',
	) );

	genesis_widget_area( 'home-section-4', array(
		'before' => '<div id="support-section" class="white-bg home-even home-section-4 widget-area"><div class="wrap">',
		'after'  => '</div></div> <div id="news-nav"></div>',
	) );

	genesis_widget_area( 'home-section-5', array(
		'before' => '<div id="news-section" class="home-odd home-section-5 widget-area"><div class="wrap">',
		'after'  => '</div></div> <div id="contact-nav"></div>',
	) );

	genesis_widget_area( 'home-section-6', array(
		'before' => '<div id="contact-section" class="home-odd home-section-5 widget-area"><div class="wrap">',
		'after'  => '</div></div>',
	) );
