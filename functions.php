...
genesis_register_sidebar( array(
	'id'          => 'home-section-6',
	'name'        => __( 'Home Section 6', 'parallax-pro' ),
	'description' => __( 'This is the home section 6 section.', 'parallax-pro' ),
) );
...
function custom_load_custom_style_sheet() {
 wp_enqueue_style( 'custom-stylesheet', get_stylesheet_directory_uri() . '/style-us.css', array(), '1.0.0' );
}
